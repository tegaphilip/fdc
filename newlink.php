...
if(isset($_POST['Submit'])){
    $reg_response = $member->sendNewActivationLink();
}
	...
	<?php require_once('header.php');?>
      ...
      <!--SLIDER HERE--><!--SLIDER-->
		...
		<ul class="breadcrumb">
			...
			<li class="active">Confirmation Link</li>
		</ul>
	  <p>
			<div class="span8">
				...
				<form class="form-horizontal" action="#" method="post">
					<fieldset>
						...
						<legend>Request Confirmation Link</legend> 
                      ...
                      <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						  <button class="btn btn-primary btn-large" type="submit" name="Submit" id="Submit">Submit</button>
						</div>
					  </div>
                     </fieldset>
				  </form>
