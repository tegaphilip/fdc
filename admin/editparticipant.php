...
if(isset($_POST['Save'])){
    $response = $conference->updateParticipant();
}

$participant = $util->getDetails(CONFERENCE_ATTENDANCE, ATTENDEE_ID, base64_decode($_GET[ID]));
                  ...
                  <div class="widget-body">
                    ...
                    <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						  <input value="<?php echo $participant[FULL_NAME]; ?>" name="<?php echo FULL_NAME; ?>" type="text" class="span4" id="<?php echo FULL_NAME; ?>" placeholder="E.g. Dr. Lawal Kwali">
						</div>
					  </div>
					  ...
					  <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						  <input value="<?php echo $participant[EMAIL]; ?>" name="<?php echo EMAIL; ?>" type="text" class="span4" id="<?php echo EMAIL; ?>" placeholder="Email">
						</div>
					  </div>
...
<label class="control-label">Is this person a member of FDC?</label>
						<div class="controls docs-input-sizes">
                                                    <table width='50%'>
                                                        <tr>
                                                            <td><input type="radio" name="<?php echo IS_MEMBER; ?>" id="<?php echo IS_MEMBER; ?>" value="1" 
                                                                <?php if($participant[IS_MEMBER]=="1") echo 'checked="checked"'; ?>>
                      <label for="radio">Yes</label></td>
                                                            <td><input type="radio" name="<?php echo IS_MEMBER; ?>" id="<?php echo IS_MEMBER; ?>" value="0" 
                          <?php if($participant[IS_MEMBER]=="0") echo 'checked="checked"'; ?>>
                       ...
                       <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						 <select name="<?php echo CONFERENCE_ID; ?>" id="<?php echo CONFERENCE_ID; ?>">
                             ...
                             {
                             ?>
                                <option <?php if($participant[CONFERENCE_ID]==$reg[CONFERENCE_ID]) echo "selected='selected'"; ?>
						...
						<div class="controls docs-input-sizes">
						 <select name="<?php echo CONFERENCE_REGISTRATION_TYPE_ID; ?>" id="<?php echo CONFERENCE_REGISTRATION_TYPE_ID; ?>">
                             ...
                             {
                             ?>
                                <option <?php if($participant[CONFERENCE_REGISTRATION_TYPE_ID]==$reg[CONFERENCE_REGISTRATION_TYPE_ID]) echo "selected='selected'"; ?>
					  ...
					  <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						  <input value="<?php echo $participant[TELEPHONE]; ?>" name="<?php echo TELEPHONE; ?>" type="text" class="span4" id="<?php echo TELEPHONE; ?>" placeholder="Phone number">
						</div>
					  </div>
                      ...
                      <div class="control-group">
						...
						<div class="controls docs-input-sizes">
						 <select name="<?php echo AFFILIATION_ID; ?>" id="<?php echo AFFILIATION_ID; ?>">
                             ...
                             {
                             ?>
                                <option <?php if($participant[AFFILIATION_ID]==$aff[AFFILIATION_ID]) echo "selected='selected'"; ?>
                         ...
                         <div class="control-group">
                            ...
                            <div class="controls docs-input-sizes">
                                <input value="<?php echo $participant[AMOUNT_PAID]; ?>" name="<?php echo AMOUNT_PAID; ?>" type="text" class="span4" id="<?php echo AMOUNT_PAID; ?>" placeholder="Amount this person paid">
                            </div>
                        </div>
                            ...
                            <div class="controls docs-input-sizes">
                                <input type="checkbox" value="1" name="<?php echo PAYMENT_CONFIRMED; ?>" 
                                       id="<?php echo PAYMENT_CONFIRMED; ?>" 
                                           <?php if($participant[PAYMENT_CONFIRMED]=="1") echo "checked='checked'"; ?>/>
                            </div>
                        </div>
                      
                        <?php
                            if(!empty($participant[DATE_PAYMENT_WAS_MADE])){
                                $dstring = $participant[DATE_PAYMENT_WAS_MADE];
                                $day = date("d",$dstring);
                                $month = date("m",$dstring);
                                $year = date("Y",$dstring);
                                $time = $day."-".$month."-".$year;
                            }
                        ?>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls docs-input-sizes">
                                <input value="<?php echo $time; ?>" 
                                       name="<?php echo DATE_PAYMENT_WAS_MADE; ?>" type="text" class="span4" id="<?php echo DATE_PAYMENT_WAS_MADE; ?>" 
                                       placeholder="dd-mm-yyyy">
                                <input type="hidden" name="<?php echo ATTENDEE_ID; ?>" value="<?php echo $participant[ATTENDEE_ID]; ?>"/>
                            </div>
                        </div>
