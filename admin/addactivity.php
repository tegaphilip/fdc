...
if(isset($_POST['Save'])){
    $response = $conference->addActivity();
}

$conf = $util->getDetails(CONFERENCES, CONFERENCE_CODE, $_GET['confid']);
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls controls-row">
                            <input class="span6" type="text" placeholder="E.g Pre-Conference workshop" 
                                   ...
                                   value="<?php echo $_POST[DAY_TITLE]; ?>">
                        </div>
                      </div>
...
<!--                                <option value="">-Hour-</option>-->
                            <?php
                                for($i=1;$i<=12;$i++){
                              ?>
                              <option <?php if($_POST["sh"]==$i) echo "selected='selected'"; ?> 
...
<!--                                <option value="">-Minute-</option>-->
                            <?php
                                for($i=0;$i<=60;$i+=5){
                              ?>
                              <option <?php if($_POST["sm"]==$i && !empty($_POST["sm"])) echo "selected='selected'"; ?> 
                                  value="<?php echo $i; ?>"><?php echo strlen($i)==1?"0".$i:$i; ?></option>
                              <?php }?>
                          </select>
...
<!--                                <option value="">----</option>-->
                            <?php
                                ...
                                foreach($arr as $a){
                              ?>
                              <option <?php if($_POST["sme"]==$a) echo "selected='selected'"; ?> 
...
<!--                              <option value="">-Hour-</option>-->
                            <?php
                                for($i=1;$i<=12;$i++){
                              ?>
                              <option <?php if($_POST["eh"]==$i) echo "selected='selected'"; ?> 
                                  value="<?php echo $i; ?>"><?php echo strlen($i)==1?"0".$i:$i; ?></option>
                              <?php }?>
                          </select>
...
<!--                                <option value="">-Minute-</option>-->
                            <?php
                                for($i=0;$i<=60;$i+=5){
                              ?>
                              <option <?php if($_POST["em"]==$i && !empty($_POST["em"])) echo "selected='selected'"; ?> 
                                  value="<?php echo $i; ?>"><?php echo strlen($i)==1?"0".$i:$i; ?></option>
                              <?php }?>
                          </select>
...
<!--                                <option value="">----</option>-->
                            <?php
                                ...
                                foreach($arr as $a){
                              ?>
                              <option <?php if($_POST["eme"]==$a) echo "selected='selected'"; ?> 
                                  value="<?php echo $a; ?>"><?php echo $a; ?></option>
                              <?php }?>
                          </select>
                        </div>
