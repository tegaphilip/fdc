...
if(isset($_POST['Save'])){
    $response = $publi->createBOOK();
}

$journals = $publi->getBooks();
                       ...
                       <div class="control-group">
                        ...
                        <div class="controls controls-row">
                          <select name="<?php echo BOOK_MONTH; ?>" id="<?php echo BOOK_MONTH; ?>" class="span2">
                              ...
                              ?>
                              <option <?php if($_POST[BOOK_MONTH]==$key) echo "selected='selected'"; ?> 
                          ...
                          <select name="<?php echo BOOK_DAY; ?>" id="<?php echo BOOK_DAY; ?>"  class="span2 input-left-top-margins">
                            ...
                            <?php
                                for($i=1;$i<=31;$i++){
                              ?>
                              <option <?php if($_POST[BOOK_DAY]==$i) echo "selected='selected'"; ?> 
                          ...
                          <select name="<?php echo BOOK_YEAR; ?>" id="<?php echo BOOK_YEAR; ?>" class="span2 input-left-top-margins">
                            ...
                            <?php
                              ...
                              ?>
                              <option <?php if($_POST[BOOK_YEAR]==$i) echo "selected='selected'"; ?> 
                                  value="<?php echo $i; ?>"><?php echo $i; ?></option>
                              <?php }?>
                          </select>
                       ...
                       <div class="control-group">
                        ...
                        <div class="controls">
                          <textarea name="<?php echo BOOK_AUTHORS; ?>" id="<?php echo BOOK_AUTHORS; ?>" class="span6 input-left-top-margins" type="text" 
                                    placeholder=""><?php echo $_POST[BOOK_AUTHORS]; ?></textarea>
                        </div>
                      </div>
                      ...
                      <div class="control-group">
                        ...
                        <div class="controls controls-row">
                          <textarea name="<?php echo BOOK_ABSTRACT; ?>" id="<?php echo BOOK_ABSTRACT; ?>" class="span6 input-left-top-margins" type="text" 
                                    placeholder="" ><?php echo $_POST[BOOK_ABSTRACT]; ?></textarea>
                        </div>
                      </div>
                      ...
                      <table class="table table-condensed table-striped table-hover table-bordered pull-left" id="data-table">
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo $i%2==0?"gradeX warning":"gradeC"; ?>">
                                <td><?php echo $i+1; ?></td>
                                <td><?php echo $jour[BOOK_TITLE]; ?></td>
                                <td><?php echo $jour[BOOK_AUTHORS]; ?></td>
                                <td><?php echo $jour[BOOK_ISBN]; ?></td>
                                <td><?php echo $util->getFriendlyDate($jour[BOOK_DATE]); ?></td>
                                <td class="hidden-phone">
                                    <p>
                                        <a href="editbook.php?id=<?php echo $jour[BOOKS_ID]; ?>"><button class="btn btn-primary btn-mini"><i class="icon-pencil icon-white"></i> Edit</button></a>
                                        <a href="togglepublications.php?pubaction=deleteB&id=<?php echo $jour[BOOKS_ID]; ?>" onclick="return validateDeletion();" ><button  class="btn btn-danger btn-mini"><i class="icon-remove icon-white"></i> Delete</button></a>
                                </p>
                                </td>
                          </tr>
                            <?php
