...
if(isset($_GET['year'])){
    $query .= " WHERE book_year = '".$_GET['year']."'";
}
                ...
                <div class="overview">
                  <div class="featured-articles-container">
                    <div class="articles">
                        ...
                        ?>
                            <a href="books.php?year=<?php echo $i; ?>">
                                <span class="label-bullet">
                            &nbsp;
                            </span>
                        <?php echo $i; ?>
...
<div class="span6">
            <h4 class="breadcrumb">PUBLICATIONS (BOOKS)</h4>
            <p>
      <ul class="thumbnails">
                ...
                <div class="widget">
                  <div class="widget-body">
                    <?php
                      ...
                      <p>
                        <?php echo $bk[BOOK_TITLE]; ?>
                      </p>
                       <small>
                        <?php echo $bk[BOOK_AUTHORS]; ?><br/>
                        <cite><?php echo date("F, Y",$bk[BOOK_DATE]); ?></cite>
                       </small>
